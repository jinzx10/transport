#######################################################################
# This script performs KHF calculations for 1-D periodic copper atomic
...
parser.add_argument('--nkmax', default = 12, type = int)
...
parser.add_argument('--max_memory', default = 30000, type = int)
...
cell.build(    
        ...
        dimension = 3,    
        basis = 'aug-cc-pvdz', # use cc-pvdz as minao
        verbose = 4
        )    

# save cell
chkfile.save_cell(cell, savedir + '/cu_' + str(nat).zfill(2) + '.chk')

...
parser.add_argument('--spacing', default = 2.55, type = float)
parser.add_argument('--left', default = 2.7, type = float)
parser.add_argument('--right', default = 2.7, type = float)
parser.add_argument('--smearing', default = 0.05, type = float)
...
print('spacing between Cu atoms in the lead = ', a)
print('spacing between Au atom and left lead = ', l)
print('spacing between Au atom and right lead = ', r)
print('smearing = ', smearing)

# total number of atoms in the lead (left+right) within a unit cell
for nat in range(4, 15):
    ...
    cell.atom.append(['Au', ((nl-1)*a+l, 0, 0)])
    ...
    cell.build(    
            ...
            dimension = 3,    
            basis = {'Au':'def2-tzvp', 'Cu':'cc-pvtz'},
            ecp = {'Au':'def2-tzvp'}, # Cu does not have ECP
            verbose = 4,
    ) 
